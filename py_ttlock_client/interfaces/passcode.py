...
class PasscodeInterface(BaseInterface):
    """Passcode management operations for TTLock-compatible devices."""
    ...
    async def _request(
        ...
        """Execute a passcode API request and parse it into an optional model."""
    ...
    async def create(
        ...
        *,
        ...
        """Create a new keyboard passcode for a lock."""
    ...
    async def get(
        ...
        *,
        ...
        """Get passcode details for a lock by version/type parameters."""
        await self._ensure_login()
        payload = self._prepare_payload(
            PasscodeGetRequest(
                lockId=lock_id,
    ...
    async def get_list(
        ...
        """Return paginated list of passcodes for a lock."""
        await self._ensure_login()
        payload = self._prepare_payload(
            PasscodeListRequest(
                lockId=lock_id,
    ...
    async def change(
        ...
        *,
        ...
        """Change passcode data such as code value, name, or schedule."""
        await self._ensure_login()
        payload = self._prepare_payload(
            PasscodeChangeRequest(
                lockId=lock_id,
    ...
    async def update(
        ...
        *,
        ...
        """Alias for change() kept for API ergonomics."""
